                    ...
                    <div class="p-8 xl:px-12">
                        ...
                        <ul class="inline-flex flex-col items-start space-y-5 text-left mt-9">
                            ...
                            <li class="inline-flex items-center space-x-2">
                                ...
                                <span class="text-base font-medium text-gray-900"> Actualizacion de Stock </span>
                            </li>
                        ...
                        <a href="gestionVentas.jsp" title="" class="inline-flex items-center justify-center px-10 py-4 mt-10 text-base font-semibold text-white transition-all duration-200 rounded-md bg-gradient-to-r from-fuchsia-600 to-blue-600 hover:opacity-80 focus:opacity-80" role="button"> Acceder a Ventas </a>
                        <p class="mt-4 text-sm text-gray-500"></p>
                    </div>
                </div>
                ...
                <div class="p-8 xl:px-12">
                    ...
                    <ul class="inline-flex flex-col items-start space-y-5 text-left mt-9">
                        <li class="inline-flex items-center space-x-2">
                            ...
                            <span class="text-base font-medium text-gray-900"> Agregar Clientes</span>
                        </li>
